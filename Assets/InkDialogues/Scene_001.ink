...
질문. 침묵. 매뉴얼대로의 체벌. # name: DEMIAN
그래도 안 되면 주사. # name: DEMIAN

오스텐 놈들이란. # name: DEMIAN
사람 살이 붙은 기계 같다는 생각이 # name: DEMIAN
이 나라에서 지낸 날이 길수록 더 진해진다. # name: DEMIAN

(연출) 데미안, 담배 피우는 흉내를 낸다. # name: NAR

~PlaySFX("코고는 소리 멈춤")

(연출) 데미안, 등을 벽에 붙인다. # name: NAR

브로커 짓을 하며 몸에 밴 버릇이다. # name: DEMIAN
새벽에 발소리가 들린다는 건 # name: DEMIAN
대부분 좋은 쪽이 아니었다. # name: DEMIAN

~PlaySFX("군화 소리")

(연출) 철문 아래 틈새로 불빛이 흘러든다. # name: NAR
